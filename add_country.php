      ...
      <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-merge">
                          ...
                          <input class="form-control" placeholder="Country Name" name="country_name" type="text" value="<?php echo $country; ?>" required>
                        </div>
                      </div>
                    </div>
                    <!--  -->
                  </div>
                <input type="submit" class="btn btn-success" name="add_country" value="Add">
                <input type="submit" class="btn btn-danger" name="update_country" value="Update">
                </form>
                <?php edit_country(); ?>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">View Countries</h3>
            ...
            <div class="table-responsive py-2">
              <table class="table table-flush" id="datatable-basic">
                ...
                <tbody>              
                    <?php get_all_countries($loginuser,11); ?>
                </tbody>
              </table>
            </div>
          </div>
