...
<body>
  <style type="text/css">
    #verify_fail,#verify_success,#ppidentification,#biometric_fail
    {
      display: none;
    }
    #errorclass
              ...
              <div class="card-body">
                <form>
                  <div class="row">
                      ...
                      <?php
                      if(date_search_rights($loginuser,17)==1){
                        ?>
                        <div class="col-md-6">
                          <div class="form-group">                     
    ...
    function biofunction(){
      ...
      if(cand_ident == ""){
        ...
        if(verified_template == "")
        {
          ...
          get_candidate_with_biometric(cand_ident,'ppidentification');
