                    ...
                    <div class="col-md-6">
                         ...
                         <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <a href="reports/registration_slip?barcode=<?php echo base64_encode($bar); ?>" target="_blank"><button type="button" id="printslip" class="btn btn-default">Print</button></a>
                            <a href="registration_history" target="_blank"><button type="button" id="search" class="btn btn-warning">Search</button></a>
