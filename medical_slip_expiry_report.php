        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Medical Slip Expiry Report</h6>
        ...
        <div class="col-lg-6">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <!-- Card body -->
              <div class="card-body">
                <form method="post" action="reports/medical_slip_expiry_report">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label">Select Date</label>
                        <input class="form-control datepicker" name="reg_date" placeholder="mm/dd/yyyy" type="text">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
