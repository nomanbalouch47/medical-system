                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="reg_date" id="reg_date" value="<?php echo ($reg_date) ? date('d-m-Y',strtotime($reg_date)) : ''; ?>" readonly>
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2" style="padding-left: 0px;">
                      <div class="form-group pull-left">
                        <a href="reports/medical_officer_report?regno=<?php echo $regid; ?>" target="_blank"><button type="button" id="print" name="print" class="btn btn-primary">Print</button></a>
                      </div>
                    </div>
        ...
        $(document).ready(function() {
                   ...
                   $.ajax({
                      ...
                      success: function(data) {
                          ...
                          document.getElementById("medical_status").innerHTML  = data; 
                      },
