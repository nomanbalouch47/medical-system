...
<body>
    <style type="text/css">
    #verify_fail,#verify_success,#xray
    {
      display: none;
    }
    #errorclass
...
<script type="text/javascript">
    ...
    var token_num = document.getElementById("token_number").value;
    ...
    function matchScore(succFunction, failFunction) {
        ...
        if(verified_template == "")
        {
          ...
          get_candidate_with_biometric(token_num,'xray');
